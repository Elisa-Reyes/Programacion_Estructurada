...
def anadir(usuario_id):
    ...
    if titulo and autor and estan:
        ...
        print("Información necesaria: Titulo, Autor y Estantería")
        funciones.arte()
...
def mostrar(usuario_id):
    ...
    if len(todos_lib)>0:
        print("\n\tTodos los Libros en la Biblioteca 𖹭")
...
def buscar(usuario_id):
    print("Buscar Libro en Especifico 𖹭")
