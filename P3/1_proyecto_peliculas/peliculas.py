...
def modificarPeliculas():
   ...
   if conexionBD!=None:
      ...
      if registros:
        ...
        if resp=="si":
          nuevo_nombre = input(f"nombre: ").strip().upper()
          nuevo_categoria = input(f"categoria: ").strip().upper()
          nuevo_clasificacion = input(f"clasificacion: ").strip().upper()
          nuevo_genero = input(f"genero: ").strip().upper()
          nuevo_idioma = input(f"idioma: ").strip().upper()
          sql=f"UPDATE peliculas SET nombre = %s, Categoria = %s, Clasificacion=%s, Genero=%s, Idioma=%s WHERE Nombre = %s"
          val=(nuevo_nombre, nuevo_categoria, nuevo_clasificacion, nuevo_genero, nuevo_idioma, nombre)
          cursor.execute(sql,val)
          conexionBD.commit()
          print("\n\t\t :::¡LA OPERACION SE REALIZÓ CON EXÍTO! :::")  
      else:
